    ...
    "прочесть дневник джодаха": {
     ...
     "аномалия": {
        ...
        "responses": [
            ...
            "{user} увидел(-а-) аномалию врат Отправления и даже не обратил(-а-) внимания 🟣",
            ...
            "{user} увидел(-а-) аномалию с отвязкой и едва не погиб(-ла-) от перегрузки 😵‍💫 ",
            "{user} увидел(-а-) аномалию с ужасными монстрами и активировал(-а-) Искру ✴️",
            ...
            "{user} увидел(-а-) аномалию с Воплощёнными и закрылся(-ась-) в сонном измерении на месяц 🏠 ",
            "{user} увидел(-а-) аномалию с масками Первых и нахлынули старые воспоминания 🎭 ",
            "{user} увидел(-а-) аномалию с взломанным Г.Л.А.С и решил(-а-) что повременит с белым пространством ⬜️ ",
            "{user} благодаря аномалии смог узнать имя другого существа и навалял(-а-) ему 🤩 ",
            "{user} услышал(-а-) от Риз очередную чересчур знакомую фразу, что же это может значить? 🤔",
            "{user} увидел(-а-) аномалию и переместился(-ась-) в белое пространство 👻 ",
     ...
     "алгоритм": {
        ...
        "responses": [
            ...
            "{user} отправился(-ась-) на свой алгоритм и теперь будет вычищать канализацию как Мартин💩",
            "{user} отправился(-ась-) на свой алгоритм и теперь будет перебирать тонну бумаг📄",
            "{user} отправился(-ась-) на свой алгоритм и теперь будет читать свои лучшие произведения на сцене📖",
            "{user} отправился(-ась-) на свой алгоритм и теперь будет следить за правопорядком👮‍♂️",
